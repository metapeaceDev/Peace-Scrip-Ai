...
export const MotionEditorPage: React.FC<MotionEditorPageProps> = ({ 
  ...
  const [leftPanelTab, setLeftPanelTab] = useState<'prompts' | 'info' | 'characters' | 'dialogue' | 'setart' | 'props'>('prompts');
  ...
  const [characters, setCharacters] = useState([
    { id: 1, name: 'Main Character', description: 'Worn warrior with battle scars', age: '30s', role: 'Protagonist' },
  ...
  const [props, setProps] = useState([
    ...
    { id: 2, name: 'Lantern', description: 'Dim glowing lantern', quantity: 1, importance: 'Medium' },
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
              ...
              {leftPanelTab === 'prompts' && (
                <div className="flex flex-col h-full">
                  ...
                  <div className="space-y-2 overflow-y-auto flex-1" style={{ maxHeight: 'calc(100vh - 450px)' }}>
                    {prompts.map(prompt => (
              ...
              {leftPanelTab === 'info' && (
                <div className="flex flex-col h-full">
                  <h3 className="text-lg font-bold text-blue-400 mb-3 flex-shrink-0">ℹ️ Shot Information</h3>
                  
                  <div className="space-y-2 text-sm overflow-y-auto flex-1" style={{ maxHeight: 'calc(100vh - 450px)' }}>
              ...
              {leftPanelTab === 'characters' && (
                <div className="flex flex-col h-full">
                  ...
                  <div className="space-y-3 overflow-y-auto flex-1" style={{ maxHeight: 'calc(100vh - 450px)' }}>
                    {characters.map(char => (
                      ...
                      <div key={dlg.id} className="p-3 bg-gray-700/50 rounded-lg">
                        <div className="flex gap-2 mb-2">
                          <input
                            type="text"
                            value={dlg.character}
                            onChange={(e) => setDialogues(dialogues.map(d => 
              ...
              {leftPanelTab === 'setart' && (
                <div className="flex flex-col h-full">
                  <h3 className="text-lg font-bold text-orange-400 mb-3 flex-shrink-0">🎨 Set & Art Direction</h3>
                  ...
                  <div className="space-y-3 overflow-y-auto flex-1" style={{ maxHeight: 'calc(100vh - 450px)' }}>
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-400 mb-1">Time of Day</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-400 mb-1">Weather</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-400 mb-1">Atmosphere</label>
                      <textarea
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-400 mb-1">Color Palette</label>
                      <textarea
                    ...
                    {props.map(prop => (
                      <div key={prop.id} className="p-3 bg-gray-700/50 rounded-lg">
                        <input
                          type="text"
                          value={prop.name}
                          onChange={(e) => setProps(props.map(p => 
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            value={prop.quantity}
                            onChange={(e) => setProps(props.map(p => 
                              p.id === prop.id ? { ...p, quantity: parseInt(e.target.value) || 1 } : p
                            ))}
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    className="w-16 h-1"
                  />
                  <span className="text-[10px] text-gray-500 font-mono">{timelineZoom.toFixed(1)}x</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    className="w-16 h-1"
                  />
                  <span className="text-[10px] text-gray-500 font-mono">{duration.toFixed(1)}s</span>
                </div>
              </div>
