    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
         ...
         <button
          ...
          title={!scriptData.mainGenre ? 'กรุณาเลือก Genre ใน Step 1 ก่อน' : 'Generate structure from Step 1-3 data'}
        >
          {isGenerating ? (
            <>
      ...
      {isGenerating && (
        <div className="mb-6 p-4 bg-indigo-900/20 border border-indigo-500 rounded-lg">
          <div className="flex items-start gap-3">
            <svg className="animate-spin h-5 w-5 text-indigo-400 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            <div className="text-sm text-indigo-300">
              ...
              <p className="text-xs text-indigo-400">
                • วิเคราะห์ Genre และ Characters จาก Step 1-3<br/>
                • สร้าง Plot Points แบบ Hollywood Structure
              </p>
            </div>
          </div>
        </div>
