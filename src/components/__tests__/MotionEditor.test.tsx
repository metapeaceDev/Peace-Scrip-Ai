...
describe('MotionEditor', () => {
  ...
  describe('Component Initialization', () => {
    ...
    it('should initialize with provided motion edit', () => {
      ...
      render(
        <MotionEditor 
          initialMotionEdit={initialMotion}
  ...
  describe('Panel Management', () => {
    ...
    it('should show all panel buttons', () => {
      render(<MotionEditor onMotionChange={onMotionChange} />);
      const panels = screen.getAllByRole('button').filter(btn => 
  ...
  describe('Shot Preview Panel', () => {
    ...
    it('should have shot type preset buttons', () => {
      ...
      const shotTypes = ['Wide Shot', 'Medium Shot', 'Close-up', 'Extreme Close-up', 'Over-the-Shoulder', 'Two Shot'];
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty initial motion edit', () => {
      const emptyMotion = {
        shot_preview_generator_panel: { structure: '', prompt: '', shot_type: 'Medium Shot' as const },
        camera_control: { shot_prompt: '', perspective: 'Neutral' as const, movement: 'Static' as const, equipment: 'Tripod' as const, focal_length: '50mm' as const },
