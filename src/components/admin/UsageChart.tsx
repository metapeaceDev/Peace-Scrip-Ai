...
export const UsageChart: React.FC<UsageChartProps> = ({ usage }) => {
  ...
  const generateWeeklyData = () => {
    ...
    for (let i = 7; i >= 0; i--) {
      ...
      const baseApiCalls = (usage.apiCalls.scripts + usage.apiCalls.images + usage.apiCalls.videos) / growthFactor;
    ...
    <div className="usage-chart-container">
      <div className="chart-header">
        ...
        <div className="chart-metrics">
          ...
          <div className="metric-item">
            ...
            <span className="metric-value api">{(usage.apiCalls.scripts + usage.apiCalls.images + usage.apiCalls.videos).toLocaleString()}</span>
          </div>
          <div className="metric-item">
      ...
      <div className="chart-footer">
        <p className="chart-note">
          💡 <strong>Note:</strong> Usage data shown for the last 8 weeks. 
          Data represents cumulative usage per week.
        </p>
      </div>
    </div>
  );
