    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* ⭐ THEME - MOST IMPORTANT FIELD */}
          <div className="relative">
            <div className="absolute -left-2 top-0 bottom-0 w-1 bg-gradient-to-b from-yellow-500 via-orange-500 to-red-500 rounded-full"></div>
            <div className="bg-gradient-to-br from-yellow-900/20 via-orange-900/20 to-red-900/20 border-2 border-yellow-600/40 rounded-lg p-4">
              <div className="flex items-start gap-2 mb-2">
                ...
                <div className="flex-1">
                  <label htmlFor="theme" className="block text-lg font-bold text-yellow-300 mb-1">
                    {t('step2.fields.theme')} ⭐ <span className="text-xs font-normal text-yellow-400/80">(หัวใจของเรื่อง - สำคัญที่สุด)</span>
                  </label>
                  <div className="text-xs text-yellow-200/70 mb-3 space-y-1 leading-relaxed">
                    <p>💡 <strong>Theme คือ:</strong> ความจริงสากลที่ตัวละครและผู้ชมจะได้เรียนรู้ไปพร้อมกัน</p>
                    <p>🎯 <strong>หน้าที่:</strong> ควบคุมทิศทางเรื่อง ไม่ให้ขัดแย้งกับหลักธรรมชาติและหลักธรรม</p>
                    <p>📚 <strong>ตัวอย่าง:</strong> "ความกล้าที่แท้จริงคือการกระทำในสิ่งที่ถูกต้อง แม้จะกลัว", "ความรักต้องมีการเสียสละ", "ความโลภนำมาซึ่งความหายนะ"</p>
                  </div>
                </div>
              </div>
              <textarea 
                ...
                onFocus={handleFocus} 
                rows={3} 
                className="w-full bg-gray-900/50 border-2 border-yellow-600/30 focus:border-yellow-500 rounded-md py-3 px-4 text-yellow-50 focus:ring-2 focus:ring-yellow-500/50 placeholder-yellow-700/50 font-medium leading-relaxed"
                placeholder={t('step2.fields.themePlaceholder')}
              ></textarea>
              <div className="mt-2 flex items-start gap-2 text-xs text-yellow-300/60">
                <svg className="w-4 h-4 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <p><strong>Critical:</strong> Theme ต้องสอดคล้องกับ Big Idea และเป็นตัวกำหนดว่าเหตุการณ์ใดเกิดขึ้นได้/ไม่ได้ในเรื่อง</p>
              </div>
            </div>
          </div>
