...
export const BhumiIndicator: React.FC<BhumiIndicatorProps> = ({
  ...
  if (!showDetails) {
    return (
      <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${style.gradient} border ${style.border}`}>
  ...
  return (
    <div className={`p-6 bg-gradient-to-br ${style.gradient} rounded-xl border-2 ${style.border} shadow-sm`}>
