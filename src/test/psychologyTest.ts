...
import { calculatePsychologyProfile, calculateReaction, formatPsychologyForPrompt } from '../services/psychologyCalculator';
...
export function runPsychologyTests() {
  ...
  console.log(`  - นายพลอุดม: ${politicianReaction.emotionalTone} (${politicianReaction.reactionType})`);
  console.log('');
