...
export const DIALECT_PRESETS = {
  standard: {
    ...
    examples: ['สวัสดีครับ', 'ขอบคุณค่ะ', 'ไปไหนมา'],
  },
  isaan: {
    ...
    examples: ['บ่รู้เด้อ', 'กินข้าวแล้วบ่', 'ไปใส', 'เป็นหยังของ', 'แซบหลายเด้อ'],
  },
  northern: {
    ...
    examples: ['ไปใสจ๊า', 'กินข้าวแล้วบ่', 'ดีหลายเจ้า', 'เป็นหยังเนอ'],
  },
  southern: {
    ...
    examples: ['กินข้าวกันจ๋า', 'ปะไรวะ', 'ดีจ๋าเหา', 'ไปไหนโว้ย'],
  },
  central: {
    ...
    commonWords: {},
    suffixes: ['ครับ', 'ค่ะ'],
    examples: ['สวัสดีครับ', 'ขอบคุณมากค่ะ'],
  },
};
