...
describe('usageTracker - Usage Tracking', () => {
  ...
  it('should accumulate credits used', async () => {
    const { trackImageGeneration, getUsageStats, resetUsageStats } = await import('../usageTracker');
...
describe('usageTracker - Video Tracking', () => {
  it('should track video generation with duration', async () => {
    const { trackVideoGeneration, getUsageStats, resetUsageStats } = await import('../usageTracker');
...
describe('usageTracker - Storage Tracking', () => {
  it('should track storage usage by type', async () => {
    const { trackImageGeneration, trackVideoGeneration, getUsageStats, resetUsageStats } = await import('../usageTracker');
...
describe('usageTracker - Reset Functionality', () => {
  it('should reset all stats to zero', async () => {
    const { trackImageGeneration, resetUsageStats, getUsageStats } = await import('../usageTracker');
