...
async function checkData() {
  ...
  console.log('   Active (30d):', activeCount);
  console.log('   By Tier:', tierCount);
  console.log('');
  ...
  console.log('   Avg per user:', Math.round(totalCredits / totalUsers));
  console.log('');
  console.log('🎬 Veo Videos:', totalVeo);
  console.log('');
  console.log('📞 API Calls:');
  console.log('   Scripts (S):', apiCalls.scripts);
  console.log('   Images (I):', apiCalls.images);
  console.log('   Videos (V):', apiCalls.videos);
